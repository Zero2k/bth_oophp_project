                ...
                <div class="form-group">
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control-custom" name="category" value="<?= $category->category ?>" placeholder="Category" required>
                        </div>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary btn-block btn-user">Update Category</button>
            </form>
        </div>
